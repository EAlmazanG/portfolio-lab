                            ...
                            {filteredAssets.map((asset: AssetManagerListItem) => (
                              <button
                                ...
                                className={cn(
                                  ...
                                  selectedAssetId === asset.id && "border-primary/50 bg-primary/5 ring-1 ring-primary/10"
                                )}
                              >
                  ...
                  <div className="p-6 rounded-2xl border border-border-dark bg-surface-dark/60 space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <h2 className="text-lg font-black">Defaults & Bulk Sync</h2>
                      </div>
                      <SettingsIcon size={18} className="text-primary" />
                    </div>
                    <button
                      ...
                      className="w-full px-4 py-2 rounded-xl bg-primary text-background-dark font-bold text-xs uppercase tracking-wide flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(19,236,91,0.2)] disabled:opacity-50"
                    >
                      <RefreshCcw size={14} />
